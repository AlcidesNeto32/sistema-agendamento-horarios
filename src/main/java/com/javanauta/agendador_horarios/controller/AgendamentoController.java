...
public class AgendamentoController {
    ...
    @GetMapping
    public ResponseEntity<List<Agendamento>> buscarAgendamentosDia(@RequestParam LocalDate dataAgendamento) {
        return ResponseEntity.ok().body(agendamentoService.buscarAgendamentosDia(dataAgendamento));
    }
